...
function initializeCountdown() {
    ...
    // Set default initial display values to 00
    if (daysElement) daysElement.textContent = '00';
    if (hoursElement) hoursElement.textContent = '00';
    if (minutesElement) minutesElement.textContent = '00';
    if (secondsElement) secondsElement.textContent = '00';
    
    // Clear input field so no countdown starts automatically
    if (birthdayInput) {
        birthdayInput.value = '';
    }
}
...
function updateCountdown() {
    ...
    if (!birthdayInput.value) {
        ...
        if (countdownMessage) {
            countdownMessage.innerHTML = '<p>I hope your day is as bright, joyful, and beautiful as your heart is. May this year bring you all the love, magic, success, and endless happiness you so deeply deserve. Keep shining and being the incredible person you are. And these gonna be happend only you try to achieve peace!!</p>';
        }
        return;
    }
